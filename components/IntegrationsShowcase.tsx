        ...
        >
          <img
            ...
            onError={(e) => {
              ...
              const target = e.target as HTMLImageElement;
              if (target.src.includes('minilogo.svg')) {
                target.src = '/Logov2.svg';
              } else {
          ...
          <div className="absolute inset-0 flex items-center justify-center text-gray-800 font-bold text-2xl md:text-3xl">
            <span style={{ display: 'none' }} className="fallback-text">CL</span>
          </div>
        </div>
