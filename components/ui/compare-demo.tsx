        ...
        firstContent={
          <div className="h-full w-full bg-black/80 backdrop-blur-sm p-12 flex flex-col text-white relative">
            ...
            <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <h2 className="text-4xl font-bold text-center leading-none whitespace-nowrap text-purple-400" style={{ lineHeight: '1', margin: 0, padding: 0, transform: 'translateY(-2px)' }}>Vision</h2>
            </div>
