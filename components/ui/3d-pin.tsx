...
export const PinContainer = ({
  ...
  return (
    <div
      className={`relative group/pin z-10 cursor-pointer ${containerClassName}`}
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        <>
          <motion.div
            ...
            className="absolute left-1/2 top-1/2  h-20 w-20 rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
          ></motion.div>
          <motion.div
            initial={{
              opacity: 0,
